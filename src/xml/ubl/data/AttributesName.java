...
public enum AttributesName {
    ...
    INVOICETYPE_CODE("InvoiceTypeCode"),
    DOCUMENTCURRENCY_CODE("DocumentCurrencyCode"),
    ISSUE_DATE("issueDate"),
    DUE_DATE("dueDate"),
    DELIVERY_DATE("deliveryDate"),
    ADDRESS_STREET("addressAndStreet"),
    ZIP_CODE("addressAndStreet"),
