...
public enum ElementsName {
   ...
   DUE_DATE(NamespacesName.CBC_NAMESPACE.label+"DueDate"),
   DELIVERY_DATE(NamespacesName.CBC_NAMESPACE.label+"deliveryDate"),
   ADDRESS_STREET(NamespacesName.CBC_NAMESPACE.label+"addressStreet"),
   ZIP_CODE(NamespacesName.CBC_NAMESPACE.label+"zipCode"),
   COUNTRY_CODE(NamespacesName.CBC_NAMESPACE.label+"countryCode"),
   COUNTRY_ZONE(NamespacesName.CBC_NAMESPACE.label+"countryZone"),
   ...
   ADDRESS_FORMAT_CODE(NamespacesName.CBC_NAMESPACE.label+"AdditionalStreetName"),
   POSTBOX(NamespacesName.CBC_NAMESPACE.label+"Postbox"),
   STREET_NAME(NamespacesName.CBC_NAMESPACE.label+"StreetName"),
   BUILDING_NUMBER(NamespacesName.CBC_NAMESPACE.label+"InvoiceNumber"),
   INVOICE_NUMBER(NamespacesName.CBC_NAMESPACE.label+"Number"),
   INVOICETYPE_CODE(NamespacesName.CBC_NAMESPACE.label+"InvoiceTypeCode"),
   CITY_NAME(NamespacesName.CBC_NAMESPACE.label+"CityName"),
   POSTAL_ZONE(NamespacesName.CBC_NAMESPACE.label+"CountrySubentity"),
   ...
   COMPANYLEGAL_FORM(NamespacesName.CBC_NAMESPACE.label+"CompanyLegalForm"),
   ...
   CLASSIFIED_TAX_CATEGORY(NamespacesName.CAC_NAMESPACE.label+"ClassifiedTaxCategory"),
   ...
   CUSTOMER_ADDRESSS(NamespacesName.CAC_NAMESPACE.label+"customerAddress"),
   CURRENCY_CODE(NamespacesName.CAC_NAMESPACE.label+"currnecyCode"), 
   DOCUMENTCURRENCY_CODE(NamespacesName.CBC_NAMESPACE.label+"DocumentCurrencyCode");
