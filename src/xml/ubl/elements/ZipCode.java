...
import xml.ubl.elements.AddressAndStreet.AddressAndStreetBuilder;

public class ZipCode {
	private Document doc;
    private Element element;
    private String name = ElementsName.ZIP_CODE.label;
     ...
     * </ul>
     */
    private ZipCode(ZipCodeBuilder builder) {
    ...
    public static class ZipCodeBuilder {
        ...
        public ZipCodeBuilder documentLinked(Document doc){
            this.doc = doc;
            return this;
        }
        public ZipCodeBuilder elementFather(Element element){
            this.element = element;
            return this;
        }
        public ZipCodeBuilder value(String value){
            this.value = value;
            return this;
        }
        public ZipCodeBuilder attributes(PatternLanguage patternLanguage){
            this.patternLanguage = patternLanguage;
            return this;
        }
        
        public ZipCode build(){
        	ZipCode element = new ZipCode(this);
            return element;
        }
    ...
    public Element load() {
        ...
        if(!(patternLanguage == null)){
            if(!(patternLanguage.getLanguageID() == null)){
                Attr elementRoot_Attr1 = new AttributeT(doc, elementRoot, AttributesName.ZIP_CODE.label, patternLanguage.getLanguageID()).load();
            }
        }
		return elementRoot;
    }
